...
struct PMC_mod_out_socket: sc_module
{
  // TLM-2 socket, defaults to 32-bits wide, base protocol
  //tlm_utils::simple_initiator_socket<Initiator> socket;
  tlm_utils::simple_initiator_socket<PMC_mod_out_socket> socket;

  SC_CTOR(PMC_mod_out_socket)
  : socket("socket_rec")  // Construct and name socket
  {
